...
const BallDrawAnimation = ({ question, isWin, onAnimationEnd }) => {
    ...
    return (_jsxs("div", { className: "fixed inset-0 bg-black/40 backdrop-blur-sm flex justify-center items-center z-50 overflow-hidden", children: [_jsx(Aria, { className: "absolute bottom-4 right-4 w-28 h-28 animate-excited z-10" }), _jsxs("div", { className: "relative w-64 h-64", children: [_jsxs("svg", { viewBox: "0 0 200 200", className: "w-full h-full drop-shadow-lg", children: [_jsx("path", { d: "M 70 100 C 40 170, 160 170, 130 100 Q 100 115 70 100 Z", fill: "#a16207", stroke: "#854d0e", strokeWidth: "2" }), _jsx("g", { style: { display: step < 2 ? 'block' : 'none', transition: 'opacity 0.5s', opacity: step < 2 ? 1 : 0 }, children: balls.map((ball, i) => (_jsx("circle", { cx: ball.cx, cy: ball.cy, r: "8", fill: ball.isRed ? '#ef4444' : '#f9fafb', stroke: "#00000033", strokeWidth: "1" }, i))) }), _jsxs("g", { transform: getHandTransform(), className: "transition-transform duration-1000 ease-in-out", children: [_jsx("path", { d: "M100,50 Q120,50 120,70 L120,100 L80,100 L80,70 Q80,50 100,50 Z", fill: "transparent", stroke: "transparent", strokeWidth: "2" }), isDrawTwoProblem ? (_jsxs("g", { children: [_jsx("circle", { cx: "90", cy: "80", r: "12", fill: ball1Color, stroke: "#333", strokeWidth: "1", style: { transition: 'opacity 0.5s', opacity: step === 3 ? 1 : 0 } }), _jsx("circle", { cx: "110", cy: "80", r: "12", fill: ball2Color, stroke: "#333", strokeWidth: "1", style: { transition: 'opacity 0.5s', opacity: step === 3 ? 1 : 0 } })] })) : (_jsx("circle", { cx: "100", cy: "80", r: "12", fill: ball1Color, stroke: "#333", strokeWidth: "1", style: { transition: 'opacity 0.5s', opacity: step === 3 ? 1 : 0 } }))] })] }), step === 3 && (_jsx("div", { className: "absolute inset-x-0 -bottom-8 flex justify-center items-center", children: _jsxs("div", { className: "bg-white/90 rounded-xl px-6 py-3 text-2xl font-bold animate-swoop-in shadow-xl border-2 border-white", style: { color: isWin ? '#b91c1c' : '#374151' }, children: [_jsx("p", { className: "text-xs text-center", children: drawnBallText.en }), _jsx("p", { children: drawnBallText.ja })] }) }))] })] }));
};
