...
const Button = ({ children, text, variant = 'primary', className = '', ...props }) => {
    ...
    const textContent = text ? (_jsxs("div", { className: "relative", children: [_jsx("p", { className: `text-xs text-yellow-700 group-focus:text-yellow-200 font-sans opacity-80 transition-colors duration-150`, children: text.en }), _jsx("p", { className: `text-lg font-jp font-bold`, children: text.ja })] })) : children;
    return (_jsx("button", { className: `${baseClasses} ${variantClasses[variant]} ${disabledClasses} ${className}`, ...props, children: text ? textContent : children }));
};
